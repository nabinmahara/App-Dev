...
namespace BetterWorld.Controllers
{
    public class ApplicationController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Delete(int id, ApplicationViewModel ovm)
        {
            try
            {
                var entity = _dbContext.Application.Where(x => x.Id == id).FirstOrDefault();

                _dbContext.Application.Remove(entity);
